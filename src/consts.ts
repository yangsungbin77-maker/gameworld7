...
export const GAMES = [
	{
		...
		emoji: '⚔️',
		genre: '방치형',
		desc: '클릭으로 몬스터 사냥, 용병 자동 DPS, 꺼도 쌓이는 골드! 환생으로 무한 성장.',
		cover: '/images/games/neon-hero.svg',
	},
	{
		href: '/craft',
		title: '네온 크래프트',
	...
	},
	{
		...
		emoji: '🛩️',
		genre: '슈팅',
		desc: '아이템 먹고 무기 5단계 업그레이드! 자동 발사 비행기 슈팅, 조작은 이동뿐.',
		cover: '/images/games/neon-sky.jpg',
	},
	{
		href: '/pang',
		title: '네온 팡',
